...
const routes = [
  ...
  { path: '/tickets', name: 'tickets', component: () => import('../views/pos/TicketsView.vue') },
  {
    ...
    children: [
      ...
      { path: 'kitchen-notes', name: 'admin-kitchen-notes', component: () => import('../views/admin/KitchenNotesView.vue'), meta: { title: 'Remarques', perm: 'PRODUCTS_MANAGE' } },
      { path: 'ingredients', name: 'admin-ingredients', component: () => import('../views/admin/IngredientsView.vue'), meta: { title: 'Mots-clés', perm: 'PRODUCTS_MANAGE' } },
      { path: 'variants', name: 'admin-variants', component: () => import('../views/admin/VariantsView.vue'), meta: { title: 'Variantes', perm: 'PRODUCTS_MANAGE' } },
