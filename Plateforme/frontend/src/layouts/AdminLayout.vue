...
const nav = [
  ...
  { group: 'Catalogue', items: [
    ...
    { to: '/admin/variants', label: 'Variantes', icon: 'layers', perm: 'PRODUCTS_MANAGE' },
    { to: '/admin/ingredients', label: 'Mots-clés', icon: 'tag', perm: 'PRODUCTS_MANAGE' },
    { to: '/admin/kitchen-notes', label: 'Remarques', icon: 'note', perm: 'PRODUCTS_MANAGE' },
