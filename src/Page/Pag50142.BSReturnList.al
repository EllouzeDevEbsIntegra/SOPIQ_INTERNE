page 50142 "BS Return List"
{
    ApplicationArea = SalesReturnOrder;
    Caption = 'Liste retour bon sortie';
    CardPageID = "BS Return";
    DataCaptionFields = "Sell-to Customer No.";
    Editable = false;
    PageType = List;
    PromotedActionCategories = 'New,Process,Report,Request Approval,Release,Print/Send,Posting,Return Order';
    QueryCategory = 'Liste retour bon sortie';
    RefreshOnActivate = true;
    SourceTable = "Sales Header";
    SourceTableView = WHERE("Document Type" = CONST("Return Order"), BS = filter(true));
    UsageCategory = Lists;
