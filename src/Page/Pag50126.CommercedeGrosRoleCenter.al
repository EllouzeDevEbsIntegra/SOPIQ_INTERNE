page 50126 "Commerce de Gros Role Center"
{
    Caption = 'Commerce de Gros';
    PageType = RoleCenter;
    ...
    layout
    {
        area(rolecenter)
        {
            ...
            part(Control1901851508; "Commerce de Gros KPI")
            {
    ...
    actions
    {
        ...
        area(sections)
        {
            group(Action76)
            {
                ...
                {
                    ApplicationArea = BasicEU;
                    Caption = 'Etat liste Bl';
                    Image = Bank;
                    RunObject = report 50020;

                }

                action("Liste BL / Facturation")
                {
                    ApplicationArea = BasicEU;
                    Caption = 'Liste BL / Facturation';
                    Image = SalesInvoice;
                    RunObject = report 50230;
                }

                action("Liste RR / Facturation")
                {
                    ApplicationArea = BasicEU;
                    Caption = 'Liste RR / Facturation';
                    Image = SalesInvoice;
                    RunObject = report 50231;

                }
                action("Etat de caisse")
                {
                    ApplicationArea = BasicEU;
                    Caption = 'Etat de caisse journalier';
                    Image = Bank;
                    RunObject = report 50031;
                    ToolTip = 'Etat de caisse journalier';
                }
            ...
            group(Action63)
            {
                ...
                action(CompareQuote)
                {
                    Caption = 'Comparateurs de prix';
                    ApplicationArea = all;
                    RunObject = page "Compare Quotes List";
                }
                action(ReqWorksheet)
                {
                ...
                action(TransitFolder)
                {
                    ApplicationArea = All;
                    Caption = 'Dossier import';

                    RunObject = Page "Transit Folder List";
                }
                action(AdministrativeReceiptsList)
                {
                    ApplicationArea = all;
                    Caption = 'Réceptions administratives';
                    RunObject = Page "Administrative Receipts List";

                }
                action(RecpAnnule)
                {
                    ApplicationArea = all;
                    Caption = 'Réceptions annulées';
                    RunObject = Report "Receptions annule";
                }
            ...
            group(Action62)
            {
                ...
                action("Physical reception")
                {
                    ApplicationArea = All;
                    Caption = 'Réceptions physiques';

                    RunObject = Page "Physical Receipt List";
                }
            ...
            group("Posted Documents")
            {
                ...
                action("Bon de sortie")
                {
                    ApplicationArea = BasicEU;
                    Caption = 'Bon de sortie enregistré';
                    Image = Bank;
                    RunObject = page "Liste bon de sortie";
                    ToolTip = 'Bon de sortie enregistré';
                }
                action("Bon de sortie archivé")
                {
                    ApplicationArea = BasicEU;
                    Caption = 'Bon de sortie archivé';
                    Image = Bank;
                    RunObject = page "Liste archive Bon de sortie";
                    ToolTip = 'Bon de sortie archivé';
                }
                action("contre remboursement")
                {
                    ApplicationArea = BasicEU;
                    Caption = 'contre remboursement';
                    Image = Bank;
                    RunObject = page "Contre remboursement";
                    ToolTip = 'contre remboursement';
                }
                action(Action54)
                {
                    ApplicationArea = Basic, Suite;
