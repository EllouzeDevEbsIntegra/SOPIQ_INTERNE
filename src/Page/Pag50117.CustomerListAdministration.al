page 50117 "Customer List Administration"
{
    // 28.06.2013 EDMS P8
    //   * Added action 'Vehicles'

    ApplicationArea = Basic, Suite, Service;
    Caption = 'Administration des clients';
    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                field("Validité du"; "Validité du")
                {
                    Editable = true;
                    Visible = false;
                }

                field("Validité au"; "Validité au")
                {
                    Editable = true;
                }
                ...
                field(TotalEncoursFinancier; TotalEncoursFinancier)
                {
