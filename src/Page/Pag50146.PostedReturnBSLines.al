page 50146 "Posted Return BS Lines"
{
    Caption = 'Panier Retour BS à Acheter';
    Editable = false;
    LinksAllowed = false;
    PageType = List;
    ...
    UsageCategory = Lists;
    ApplicationArea = all;
    SourceTableView = sorting("Document No.", "Line No.") where(BS = const(true), "Quantity Invoiced" = filter(= 0), solde = filter(true), "Qty BS To Purchase" = filter(> 0));
    layout
    {
        area(content)
        {
