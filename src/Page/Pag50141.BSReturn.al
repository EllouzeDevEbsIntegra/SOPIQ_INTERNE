page 50141 "BS Return"
{
    // 20.08.2018 EB EDMS
    //   Added field: "Deal Type"
    // 
    ...
    SourceTableView = WHERE("Document Type" = FILTER("Return Order"), BS = filter(true));
        ...
        area(processing)
        {
            ...
            group(ActionGroup25006010)
            {
                ...
                action(Print)
                {
                    ...
                    begin
                        SalesLine.Reset;
                        DocMgt.PrintCurrentDoc("Document Profile", 1, 5, DocReport);
    ...
    begin
        ...
        case DocumentProfileFilter of
            Format("document profile"::"Vehicles Trade"):
                begin
                    "Document Profile" := "document profile"::"Vehicles Trade";
                    VehicleTradeDocument := true;
                end;
            Format("document profile"::"Spare Parts Trade"):
                begin
