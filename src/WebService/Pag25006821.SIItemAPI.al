page 25006821 "SI Item API"
{
    Caption = 'SI Item API';
    APIPublisher = 'sopiq';
    APIGroup = 'interne';
    APIVersion = 'v1.0';
    EntityName = 'SiItemAPI';
    EntitySetName = 'SiItemAPI';
    SourceTable = Item;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field(GroupName; Groupe)
                {
                    caption = 'Group Name';
                }
                field(SubGroupCode; "Item Sub Product Code")
                {
                    Caption = 'Sub Group Code';
                }
                field(SubGroupName; "Sous Groupe")
                {
