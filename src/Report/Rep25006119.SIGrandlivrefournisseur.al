report 25006119 "SI Grand livre fournisseur" //70042
{
        ...
        dataitem(Vendor; 23)
        {
            ...
            dataitem(Date; 2000000007)
            {
                ...
                dataitem("Detailed Vendor Ledg. Entry"; 380)
                {
                    ...
                    DataItemTableView = SORTING("Vendor No.", "Document Date", "Entry Type", "Initial Entry Global Dim. 1", "Initial Entry Global Dim. 2", "Currency Code")
                    ...
                    column(Detailed_Vendor_Ledg__Entry__Posting_Date_; FORMAT("Document Date"))
                    {
                    }
                    // column(Detailed_Vendor_Ledg__Entry__Document_Date_; FORMAT(document))
                    // {
                    // }
                    ...
                    column(Detailed_Vendor_Ledg__Entry_Posting_Date; "Document Date")
                    {
                    }
                    ...
                    column(PostingYearValue; FORMAT(DATE2DMY("Document Date", 3)))
                    {
                    }
                    ...
                    begin
                        ...
                        // Message('%1 - %2', "Detailed Vendor Ledg. Entry"."Entry No.", "Detailed Vendor Ledg. Entry"."Document Date");
            ...
            begin
                ...
                VendLedgEntry.SETCURRENTKEY(
                  "Vendor No.", "Document Date", "Entry Type", "Initial Entry Global Dim. 1", "Initial Entry Global Dim. 2", "Currency Code");
                VendLedgEntry.SETRANGE("Vendor No.", "No.");
                VendLedgEntry.SETRANGE("Document Date", 0D, PreviousEndDate);
                ...
                VendLedgEntry2.SETRANGE("Document Date", StartDate, EndDate);
