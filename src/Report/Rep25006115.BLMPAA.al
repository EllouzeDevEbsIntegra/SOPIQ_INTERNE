report 25006115 "BL MPAA"
{
    ...
    RDLCLayout = './src/report/RDLC/BLMPAA.rdl';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Shipment Line"; "Sales Shipment Line")
                    {
                        ...
                        // ici ajout des champs pour valorisation BL
                        ...
                        begin
                            ...
                            MTBRUT := (PrixVente * Quantity);
                            TotHT := TotHT + MTHT;
                            Remise := (("Unit Price" * Quantity) * ("% Discount" / 100));
                            TotRemise := TotRemise + ((PrixVente * Quantity) * ("% Discount" / 100));
                            MntTVAR := MTHT * (("VAT %" / 100));
                            MontantTVA := MTBRUT * (("VAT %" / 100));
                            // MontTTC := TotHT + MontantTVA;
                            MontTTC := MTBRUT + MontantTVA;
                            MntTTCR := MTHT + MntTVAR;
                            TauxTVA := "VAT %";
                    ...
                    field(editCustInfo; editCustInfo)
                    {
                        ...
                        begin
                            if editCustInfo = true then begin
                                ...
                                recSalesShipHeader.SetRange("No.", "Sales Shipment Header".GetFilter("No."));
    ...
    begin
        ...
        if (editCustInfo = true) then begin
            recSalesShipHeader.reset();
            recSalesShipHeader.SetRange("No.", "Sales Shipment Header"."No.");
            if recSalesShipHeader.FindFirst() then begin
            ...
            recBsArchiveHeader.SetRange("No.", "Sales Shipment Header"."No.");
