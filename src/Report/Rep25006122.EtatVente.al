report 25006122 "Etat Vente"
{


    DefaultLayout = RDLC;
    RDLCLayout = './src/report/RDLC/etatVente.rdl';
    Caption = 'Etat de vente';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            {
                DataItemLink = "Bill-to Customer No." = field("No.");
                DataItemTableView = sorting("No.") where(BS = const(false));
                column(numBL; "No.")
                {
                ...
                // dataitem(listFactureFromBL; "Sales Invoice Line")
                // {
                //     DataItemLink = "Shipment No." = field("No.");
                //     column(NumFacture; "Document No.")
                //     {
            ...
            {
                DataItemLink = "Bill-to Customer No." = field("No.");
                DataItemTableView = SORTING("No.") where("BS" = filter(true));
