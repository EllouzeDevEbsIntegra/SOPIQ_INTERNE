report 25006119 "Retour COPIM"
{
    // 24.12.2020 DELTA MJ 01
    //   Add english captions, amount format
    DefaultLayout = RDLC;
    UsageCategory = ReportsAndAnalysis;
    Caption = 'Retour BL/BS COPIM';
    ApplicationArea = All;
    RDLCLayout = './src/report/RDLC/RetourCOPIM.rdl';
    ...
    dataset
    {
        dataitem(DataItem1000000001; "Return Receipt Header")
        {
            ...
            column(OrderNo_SalesShipmentHeader; "Return Order No.")
            {
            }
            ...
            dataitem(DataItem1000000002; "Return Receipt Line")
            {
