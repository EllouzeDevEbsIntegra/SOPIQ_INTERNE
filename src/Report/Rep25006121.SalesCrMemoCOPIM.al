report 25006121 "Sales Cr Memo COPIM"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/RDLC/AvoirCOPIM.rdl';
    Caption = 'Avoir COPIM';
    ...
    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            column(No_SalesShipmentHeader; "Sales Cr.Memo Header"."No.")
            {
            }
            column(InvoiceDiscountAmount; "Invoice Discount Amount")
            {
            }
            column(BilltoCustomerNo_SalesShipmentHeader; "Sales Cr.Memo Header"."Bill-to Customer No.")
            {
            }
            column(BilltoName_SalesShipmentHeader; "Sales Cr.Memo Header"."Bill-to Name")
            {
            }
            column(PostingDate_SalesShipmentHeader; "Sales Cr.Memo Header"."Posting Date")
            {
            }
            column(BilltoAddress_SalesShipmentHeader; "Sales Cr.Memo Header"."Bill-to Address")
            {
            }
            column(BilltoCity_SalesShipmentHeader; "Sales Cr.Memo Header"."Bill-to City")
            {
            }
            column(ShiptoName_SalesShipmentHeader; "Sales Cr.Memo Header"."Ship-to Name")
            {
            }
            ...
            column(BillToCustomerNo_SalesHeader; "Sales Cr.Memo Header"."Bill-to Customer No.")
            {
            }
            column(BilltoContact_SalesHeader; "Sales Cr.Memo Header"."Bill-to Contact")
            {
            }
            ...
            column(PostingDate_SalesHeader; "Sales Cr.Memo Header"."Posting Date")
            {
            }
            ...
            column(VATRegistrationNo_SalesHeader; "Sales Cr.Memo Header"."VAT Registration No.")
            {
            }
            column(TexteLettre; TexteLettre)
            {
            }
            column(PaymentTermsCode_SalesHeader; "Sales Cr.Memo Header"."Payment Terms Code")
            {
            }
            column(OrderNo_SalesInvHeader; "Sales Cr.Memo Header"."Return Order No.")
            {
            }
            column(immatriculation; "Sales Cr.Memo Header"."Vehicle Registration No.")
            {
            }
            column(PaymentMethodCode_SalesInvoiceHeader; "Sales Cr.Memo Header"."Payment Method Code")
            {
            }
            column(VIN; VehicleRec.VIN)
            {
            }
            column(OrderDate_SalesInvHeader; "Sales Cr.Memo Header"."récépissé date")
            {
            }
            ...
            column(VehicleSerialNo; "Sales Cr.Memo Header"."Vehicle Serial No.")
            {
            }
            dataitem("Sales Inv Line"; "Sales Cr.Memo Line")
            {
            ...
            begin
                //<<MMOK 14/12/2020
                IF VehicleRec.GET("Sales Cr.Memo Header"."Vehicle Serial No.") THEN;
                //>>MMOK 14/12/2020
                ...
                //----TIMBRE
                //CHK
                IF "Sales Cr.Memo Header"."stApply Stamp Fiscal" = TRUE THEN
                    MTTIMBRE := "Sales Cr.Memo Header"."STStamp Amount"
                ELSE
                    MTTIMBRE := 0;
                    ...
                    field(editCustInfo; editCustInfo)
                    {
                        ...
                        begin
                            if editCustInfo = true then begin
                                ...
                                recSalesInvHeader.SetRange("No.", "Sales Cr.Memo Header".GetFilter("No."));
