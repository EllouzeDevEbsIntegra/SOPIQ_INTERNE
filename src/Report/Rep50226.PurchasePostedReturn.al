report 50226 "Purchase Posted Return"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/RDLC/PurchasePostedReturn.rdl';
        ...
        dataitem("Return Shipment Header"; "Return Shipment Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Entete; CompanyInfo."Invoice Header Picture")
                    {
                    }
                    column(Pied; CompanyInfo."Invoice Footer Picture")
                    {
                    }
                    ...
                    column(DocDate_ReturnShpHeader; Format("Return Shipment Header"."Document Date", 0, 0))
                    {
                    }
                    ...
                    dataitem("Return Shipment Line"; "Return Shipment Line")
                    {
                        ...
                        begin
                            ...
                            TypeInt := Type;
                            TotalHT := TotalHT + (Quantity * "Direct Unit Cost");
                            TotalNetHT := TotalNetHT + ("Item Charge Base Amount");
                            TotalTVA := TotalTVA + ("Item Charge Base Amount" * (1 + ("VAT %" / 100)));
                            TotalRemise := TotalRemise + ("Direct Unit Cost" * (1 - ("Line Discount %" / 100)));
    ...
    var
        ...
        TotalHT, TotalRemise, TotalNetHT, TotalTVA, TotalTTC : Decimal;
