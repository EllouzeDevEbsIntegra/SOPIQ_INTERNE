report 25006152 "BS BL SOPIQ"
{
    ...
    Caption = 'BS / BL SOPIQ';
    ApplicationArea = All;
    RDLCLayout = './src/report/RDLC/BSBLSOPIQ.rdl';
    ...
    dataset
    {
        dataitem(DataItem1000000001; "Entete archive BS")
        {
            ...
            dataitem(DataItem1000000002; "Ligne archive BS")
            {
                ...
                begin
                    ...
                    if BS then begin
                        ...
                        MTHT := ("Unit Price" * Quantity) - ((("Unit Price" * Quantity) * ("% Discount" / 100)));
                        TotHT := TotHT + MTHT;
            ...
            dataitem(DataItem1000000018; Integer)
            {
                ...
                begin
                    SETRANGE(Number, 1, 31 - (increment mod 31));
                end;
            }
