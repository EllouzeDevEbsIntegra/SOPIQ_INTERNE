report 50215 "Sales Invoice With Entete"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/RDLC/SalesInvoiceWithEntete.rdl';
    Caption = 'Facture Imprimer';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(CompanyAdresse; RecCompany.Address)
            {

            }

            column(CompanyTel; RecCompany."Phone No.")
            {
            ...
            column(CompanyEmail; RecCompany."E-Mail")
            {
