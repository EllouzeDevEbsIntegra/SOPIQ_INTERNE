    ...
    dataset
    {
        dataitem("Phys. Invt. Record Header"; "Phys. Invt. Record Header")
        {
            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                column(Phys__Invt__Recording_Header__Person_Recorded__; "Phys. Invt. Record Header"."Person Recorded")
                {
                }
                column(Phys__Invt__Recording_Header__Date_Recorded__; "Phys. Invt. Record Header"."Date Recorded")
                {
                }
                column(Phys__Invt__Recording_Header__Time_Recorded__; "Phys. Invt. Record Header"."Time Recorded")
                {
                }
                ...
                dataitem("Phys. Invt. Record Line"; "Phys. Invt. Record Line")
                {
                    ...
                    DataItemTableView = SORTING("Order No.", "Recording No.", "Location Code", "Bin Code", "Item No.");

                    column(Phys__Invt__Recording_Line__FIELDCAPTION_Quantity_; FieldCaption(Quantity))
                    {
                    }

                    column(Phys__Invt__Recording_Line_Quantity_PREVU; ("Phys. Invt. Record Line"."Qte Prevu"))
                    {
