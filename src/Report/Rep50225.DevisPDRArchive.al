report 50225 "Devis  PDR Archive"
{
    // DELTA 01 HT (17-05-2021) TMP
    DefaultLayout = RDLC;
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    RDLCLayout = './src/report/RDLC/DevisPDRArchive.rdl';
    ...
    dataset
    {
        dataitem("Sales Header Archive"; "Sales Header Archive")
        {
            ...
            column(No_SalesShipmentHeader; "Sales Header Archive"."No.")
            {
            }
            column(BilltoCustomerNo_SalesShipmentHeader; "Sales Header Archive"."Bill-to Customer No.")
            {
            }
            column(BilltoName_SalesShipmentHeader; "Sales Header Archive"."Bill-to Name")
            {
            }
            column(PostingDate_SalesShipmentHeader; "Sales Header Archive"."Document Date")
            {
            }
            column(BilltoAddress_SalesShipmentHeader; "Sales Header Archive"."Bill-to Address")
            {
            }
            column(BilltoCity_SalesShipmentHeader; "Sales Header Archive"."Bill-to City")
            {
            }
            column(ShiptoName_SalesShipmentHeader; "Sales Header Archive"."Ship-to Name")
            {
            }
            ...
            column(BilltoContact_SalesHeader; "Sales Header Archive"."Bill-to Contact")
            {
            }
            ...
            column(OrderDate_SalesHeader; "Sales Header Archive"."Order Date")
            {
            }
            column(SalespersonCode_SalesHeader; Salesperson.Name)
            {
            }
            column(VATRegistrationNo_SalesHeader; "Sales Header Archive"."VAT Registration No.")
            {
            }
            ...
            column(InvoiceDiscountAmount_SalesHeader; "Sales Header Archive"."Invoice Discount Value")
            {
            }
            ...
            dataitem("Sales Line Archive"; "Sales Line Archive")
            {
                ...
                column(No_SalesShipmentLine; "Sales Line Archive"."No.")
                {
                }
                column(Description_SalesShipmentLine; "Sales Line Archive".Description)
                {
                }
                column(Quantity_SalesShipmentLine; "Sales Line Archive".Quantity)
                {
                }
                column(UnitPrice_SalesShipmentLine; "Sales Line Archive"."Unit Price")
                {
                    AutoFormatExpression = "Sales Header Archive"."Currency Code";
                }
                column(VAT_SalesShipmentLine; "Sales Line Archive"."VAT %")
                {
                }
                column(VATBaseAmount_SalesShipmentLine; "Sales Line Archive"."VAT Base Amount")
                {
                    AutoFormatExpression = "Sales Header Archive"."Currency Code";
                }
                column(VariantCode_SalesShipmentLine; "Sales Line Archive"."Variant Code")
                {
                }
                ...
                column(Amount_SalesInvoiceLine; "Sales Line Archive".Amount)
                {
                    AutoFormatExpression = "Sales Header Archive"."Currency Code";
                }
                column(LineDiscountAmount_SalesInvoiceLine; "Sales Line Archive".Amount + "Sales Line Archive"."Line Discount Amount" + "Sales Line Archive"."Inv. Discount Amount")
                {
                    AutoFormatExpression = "Sales Header Archive"."Currency Code";
                }
                column(Montant_TVA; "Sales Line Archive"."Amount Including VAT" - "Sales Line Archive".Amount)
                {
                    AutoFormatExpression = "Sales Header Archive"."Currency Code";
                }
                column(AmountIncludingVAT_SalesInvoiceLine; "Sales Line Archive"."Amount Including VAT")
                {
                    AutoFormatExpression = "Sales Header Archive"."Currency Code";
                }
                column(RemiseLigne; "Sales Line Archive"."Line Discount Amount")
                {
                    AutoFormatExpression = "Sales Header Archive"."Currency Code";
                }
            ...
            begin
                ...
                MontantRemiseGlobal := MontantRemiseGlobal + "Sales Header Archive"."Invoice Discount Value";
                ...
                // END Montant
                IF Salesperson.GET("Sales Header Archive"."Salesperson Code") THEN;



                //>>DELTA 01
                CustomerPostingGroup.GET("Sales Header Archive"."Customer Posting Group");
                //<<DELTA 01


                //<< BHA 20/08/2021
                IF PaymentTerms.GET("Sales Header Archive"."Payment Terms Code") THEN;
                //>>
            end;
        }
    }
