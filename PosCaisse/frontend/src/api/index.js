...
export const api = {
  ...
  admin: {
    ...
    ticketNumbering: () => g('/ticket-numbering'),
    previewTicketNumbering: (b) => p('/ticket-numbering/preview', b),
    saveTicketNumbering: (b) => put('/ticket-numbering', b),
    setTicketCounter: (scopeKey, nextValue) => put('/ticket-numbering/counter', { scopeKey, nextValue }),
